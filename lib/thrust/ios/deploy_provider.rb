  ...
  module IOS
    class DeployProvider
      def instance(app_config, deployment_config, deployment_target)
        ...
        x_code_tools = Thrust::IOS::XCodeToolsProvider.new.instance(stdout, build_configuration, app_config.build_directory, tools_options)
        ...
        Thrust::IOS::Deploy.new(stdout, x_code_tools, agv_tool, git, testflight, app_config, deployment_config, deployment_target)
      end
    end
  end
end
